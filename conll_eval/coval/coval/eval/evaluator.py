...
def lea(input_clusters, output_clusters, mention_to_gold):
    # with open('/Users/daniel/Desktop/lemma_ce_coref/tmp/test_mention_to_gold/input_clusters','wb') as f:
    #     pickle.dump(input_clusters,f)
    # with open('/Users/daniel/Desktop/lemma_ce_coref/tmp/test_mention_to_gold/output_clusters','wb') as f:
    #     pickle.dump(output_clusters,f)    
    # with open('/Users/daniel/Desktop/lemma_ce_coref/tmp/test_mention_to_gold/mention_to_gold','wb') as f:
    #     pickle.dump(mention_to_gold,f)    
